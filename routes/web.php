...
use Zeroc0d3lab\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Zeroc0d3lab\ACL\Http\Controllers\Auth\LoginController;
use Zeroc0d3lab\ACL\Http\Controllers\Auth\ResetPasswordController;
use Zeroc0d3lab\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Zeroc0d3lab\ACL\Http\Controllers', 'middleware' => 'web'], function () {
