...
@section('content')
    <h3 class="form-title font-green">{{ config('core.base.general.base_name') }}</h3>
    <div class="content-wrapper">
        {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('username', old('username', app()->environment('demo') ? 'zeroc0d3lab' : null), ['class' => 'form-control form-control-solid placeholder-no-fix', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
            </div>
