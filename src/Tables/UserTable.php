...
namespace Zeroc0d3lab\ACL\Tables;

use Illuminate\Support\Facades\Auth;
use Zeroc0d3lab\ACL\Enums\UserStatusEnum;
use Zeroc0d3lab\ACL\Repositories\Interfaces\ActivationInterface;
use Zeroc0d3lab\ACL\Repositories\Interfaces\UserInterface;
use Zeroc0d3lab\ACL\Services\ActivateUserService;
use Zeroc0d3lab\Base\Events\UpdatedContentEvent;
use Zeroc0d3lab\Table\Abstracts\TableAbstract;
use Exception;
use Html;
