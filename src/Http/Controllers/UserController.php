...
namespace Zeroc0d3lab\ACL\Http\Controllers;

use Assets;
use Illuminate\Support\Facades\Auth;
use Zeroc0d3lab\ACL\Forms\PasswordForm;
use Zeroc0d3lab\ACL\Forms\ProfileForm;
use Zeroc0d3lab\ACL\Forms\UserForm;
use Zeroc0d3lab\ACL\Tables\UserTable;
use Zeroc0d3lab\ACL\Http\Requests\CreateUserRequest;
use Zeroc0d3lab\ACL\Http\Requests\UpdatePasswordRequest;
use Zeroc0d3lab\ACL\Http\Requests\UpdateProfileRequest;
use Zeroc0d3lab\ACL\Models\UserMeta;
use Zeroc0d3lab\ACL\Repositories\Interfaces\RoleInterface;
use Zeroc0d3lab\ACL\Repositories\Interfaces\UserInterface;
use Zeroc0d3lab\ACL\Services\ChangePasswordService;
use Zeroc0d3lab\ACL\Services\CreateUserService;
use Zeroc0d3lab\Base\Events\CreatedContentEvent;
use Zeroc0d3lab\Base\Events\DeletedContentEvent;
use Zeroc0d3lab\Base\Forms\FormBuilder;
use Zeroc0d3lab\Base\Http\Controllers\BaseController;
use Zeroc0d3lab\Base\Http\Responses\BaseHttpResponse;
use Zeroc0d3lab\Media\Repositories\Interfaces\MediaFileInterface;
use Zeroc0d3lab\Media\Services\ThumbnailService;
use Zeroc0d3lab\Media\Services\UploadsManager;
use Zeroc0d3lab\ACL\Http\Requests\AvatarRequest;
use Exception;
use File;
